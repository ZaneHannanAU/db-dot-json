...
import {utils, ParentData, DatabaseError, DataError} from './lib/index.js'
...
/**
  ...
  * @param {Object} opts
    ...
    * @param {Object} json
      * @param {Function|Array} replacer - JSON.stringify reviver
    ...
    * @param {Function} read - should be sync or return a Promise resolving to parsable JSON.
    * @param {Function} save - should be sync or return a Promise.
  * @example
  * @constructor
  */
  constructor(file, {
    filename, saveOnPush = true, saveOnDel = saveOnPush,
    init = {}, overwrite = true,
    json: { replacer = null, humanReadable = 0, reviver = null },
    ...
    this.filename = filename ? (
      ...
      file.endsWith('.json') ? file : (file+'.json')
    )
  ...
  /**
    ...
    * @private
    */
  static __processDataPath(dataPath) {
